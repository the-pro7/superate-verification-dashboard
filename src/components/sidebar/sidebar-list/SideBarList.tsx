    ...
    >
      ...
      >
        <SideBarLink
          ...
          className={`inline-flex items-center w-full flex-row gap-3 p-3 bg-white hover:bg-purple-500 hover:text-white ${isActive('/admin-dashboard/verifications-overview') && '!bg-purple-500 text-white'}`}
        >
          <GoChecklist
      ...
      >
        <SideBarLink
          ...
          className={`inline-flex items-center flex-row justify-center gap-3 w-full p-3 bg-white hover:bg-purple-500 hover:text-white ${isActive('/admin-dashboard/approved-verifications') && '!bg-purple-500 text-white'}`}
        >
          <FaUserCheck
            className={`${!expandSidebar && "text-2xl text-center"} text-xl`}
          />
      ...
      >
        <SideBarLink
          ...
          title="View all disapproved verifications"
